      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 overflow-auto p-4 md:p-6 bg-gray-50">
          ...
          <section className="mb-6 md:mb-8">
            <h1 className="text-xl md:text-2xl font-bold text-gray-800 mb-2">Hoş Geldiniz, {user?.firstName}!</h1>
            <p className="text-sm md:text-base text-gray-600">ABD Vize Başvuru Sistemi'ne hoş geldiniz. Başvuru durumunuzu ve ilerleyen adımları buradan takip edebilirsiniz.</p>
          </section>
          ...
          {isLoadingApplications ? (
            ...
            <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6 mb-6 md:mb-8">
              <h2 className="text-base md:text-lg font-semibold text-gray-800 mb-3 md:mb-4">Henüz Başvuru Bulunmuyor</h2>
              <p className="text-sm md:text-base text-gray-600 mb-4 md:mb-6">ABD vizesi için henüz bir başvurunuz bulunmuyor. Yeni başvuru oluşturmak için aşağıdaki butona tıklayabilirsiniz.</p>
              <a href="/applications/new" className="inline-flex items-center px-3 py-2 md:px-4 md:py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
          ...
          {/* Support */}
          <section className="mb-6 md:mb-8">
            <h2 className="text-base md:text-lg font-semibold text-gray-800 mb-3 md:mb-4">Yardım ve Destek</h2>
            
            <div className="grid gap-4 md:grid-cols-2">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div className="p-4 md:p-5">
                  <h3 className="text-sm md:text-base font-medium text-gray-800 mb-2">Sık Sorulan Sorular</h3>
                  <p className="text-xs md:text-sm text-gray-600 mb-3 md:mb-4">Vize başvurusu süreciyle ilgili sık sorulan soruları ve cevaplarını inceleyebilirsiniz.</p>
                  <a href="#" className="text-primary hover:text-primary/90 font-medium text-xs md:text-sm flex items-center">
                    SSS'lere Göz Atın 
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div className="p-4 md:p-5">
                  <h3 className="text-sm md:text-base font-medium text-gray-800 mb-2">İletişim</h3>
                  <p className="text-xs md:text-sm text-gray-600 mb-3 md:mb-4">Sorularınız için destek ekibimizle iletişime geçebilirsiniz.</p>
                  <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-3">
                    <a href="#" className="inline-flex items-center px-3 py-1.5 md:py-2 border border-gray-300 shadow-sm text-xs md:text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
