        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <img src="https://images.unsplash.com/photo-1508722830436-0faffb8ba5f6?ixlib=rb-1.2.1&auto=format&fit=crop&w=40&h=40&q=80" alt="SadeceAmerika logo" className="w-8 h-8 mr-2" />
              <h1 className="text-lg font-semibold text-gray-800">SadeceAmerika</h1>
            </div>
            <Link href="/">
              <span className="flex items-center text-sm text-gray-600 hover:text-primary cursor-pointer">
