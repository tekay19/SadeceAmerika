...
export function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-gray-200 py-6 md:py-10 relative overflow-hidden">
      {/* Dünya görseli (soluk, arka planda) - Sadece büyük ekranlarda göster */}
      <div className="absolute opacity-5 right-0 bottom-0 hidden md:block">
        <svg
          width="400"
          height="400"
          viewBox="0 0 100 100"
      ...
      <div className="container mx-auto px-4 relative z-10">
        {/* Grid for desktop, Accordion for mobile */}
        ...
        <div className="md:hidden space-y-4">
          ...
          <div className="border-t border-gray-100 pt-3">
            ...
            >
              <h3 className="font-semibold text-gray-800 text-base">Türkiye Ofisi</h3>
          ...
          <div className="border-t border-gray-100 pt-3">
            ...
            >
              <h3 className="font-semibold text-gray-800 text-base">ABD Ofisi</h3>
              {expandedSection === 'abd' ? (
                <ChevronUp className="h-5 w-5 text-gray-500" />
              ) : (
                <ChevronDown className="h-5 w-5 text-gray-500" />
          ...
          <div className="border-t border-gray-100 pt-3">
            ...
            >
              <h3 className="font-semibold text-gray-800 text-base">Hızlı Linkler</h3>
            ...
            {expandedSection === 'links' && (
              <ul className="text-sm text-gray-600 space-y-2 mt-3 grid grid-cols-2">
                <li>
                  <Link href="/" className="hover:text-blue-600 transition-colors flex items-center">
                    <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>
                    Anasayfa
